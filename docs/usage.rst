...
::
    ...
    input:
            -in_hic_name      .hic file generated by Juicer
            -in_hic_norm      specified normalization to extract data from .hic file
            -in_hic_res       specified resolution to extract data from .hic file
