...
void exit_with_help()
{
	printf(
		...
		"Usage: 3CONET-build [options] -in_ncontact input.n_contact -out_bimap out.bimap\n"
		"options:\n"
		"\t-in_ncontact \t HiC contact map in .n_contact format\n"
		"\t-out_bimap \t HiC contact in binary format .bimap\n"
		"\nFor instance:\n"
		"3CONET-build -in_ncontact example/cm_uniform_1000.n_contact -out_bimap example/1000.bimap\n"
	);
	exit(0);
}
