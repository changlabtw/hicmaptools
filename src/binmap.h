...
public:
	...
	void out2list( INDEX &index, char *fileName, const int bin_dis ); //output contact in pair list format for Wash U
	void out2matrix( INDEX &index, char *fileName, const string sel_chr ); //output contact in 2D matrix format for Hommer
protected:
