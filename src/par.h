...
struct PARAMETER{
// initialization
	PARAMETER() : in_binmap_name(), in_bins_name(), query_name(), output_name(), query_mode("none"), ner_bin(10), random_size(100), sel_chr("NONE"), useNormal(false), in_hic_name("NONE"), in_hic_norm("NONE"),  in_hic_res() {}
